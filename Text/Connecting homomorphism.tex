...
\begin{center}
	% https://tikzcd.yichuanshen.de/#
	\begin{tikzcd}
...
via $\psi$ we get a map $V_j\to \overline{D^k}$, which lets us build a map 
\begin{align*}
...
Now we have the homromorphism
\begin{align*}
	\overline{D^k}\times I \big/ \big(\partial \overline{D^k}\times I\cup \overline{D^k}\times \{0,1\} \big) 
				&\to \overline{D^{k+1}} \big/ \partial \overline{D^{k+1}}\\
	(x,t)		&\mapsto \norm{(\norm{x}_2,t)}_{\infty} (x,t) 
\end{align*}
\todo{passt noch nicht}
\end{proof}
