...
We have the map 
        ...
        \resizebox{\textwidth}{!}{$
        	\begin{aligned}
        		\beta: \left[ N_q \cup N_p \cup C_1(L_q \cup N_p)\cup C_2(N_q\cup N_p) \right] & \to \left[ \frac{N_q\cup N_p \cup C_1(L_q\cup N_p)\cup C_2(N_q \cup N_p)}{C_2(N_q \cup N_p)}  ,  \frac{ C_1 (L_p \cup \overline{(L_q  \setminus N_p)}) \cup  C_2(N_q \cup N_p)}{C_2(N_q\cup N_p)} \right] \\
        		x & \mapsto \left\{ 
        		\begin{array}{ll}
        			p& \text{if } x\in C_2(N_q \cup N_p)   \\
        			x& \text{else }
...
\begin{center}
	\begin{adjustbox}{max width=\textwidth}
% https://tikzcd.yichuanshen.de/#-VmvAUoPBwFsOVKKVMgggtBgHkYBxgwA2JK2O32h2OakJ7nKlNReNMfKxOKciMxnh8-lqcVG8CIoFBEF2SDsNBwECQZHiHXYWGkwEEqR29CCXAAVMFnqr1Yg9dqkDF9b8QIImGhfPRrbaVR41RqtTrEABmb4JToe-jeei7U5+uoge1ICMgZ2IV0-aOm81JyhBIA
\begin{tikzcd}
	{K^p \big[S_1 \wedge (L_q \cup N_p) \big]} \arrow[r, "\alpha^*"]                                                                              & {K^p \left[ N_q \cup N_p \cup C_1(L_q \cup N_p)\cup C_2(N_q\cup N_p) \right]}                                                                                                                                                    \\
	{K^{p} \big[S_1 \wedge L_q\cup N_p , S_1 \wedge  L_p \cup (L_q \setminus \mathring{N_p})\big]} \arrow[u, "i_{\beta}^*"] \arrow[r, "\gamma^*"] & {K^p \left[ \frac{N_q\cup N_p \cup C_1(L_q\cup N_p)\cup C_2(N_q \cup N_p)}{C_2(N_q \cup N_p)}  ,  \frac{ C_1 (L_p \cup \overline{(L_q  \setminus N_p)}) \cup  C_2(N_q \cup N_p)}{C_2(N_q\cup N_p)} \right]} \arrow[u, "\beta^*"]
\end{tikzcd}
	\end{adjustbox}
...
\end{align*} since $\alpha$ and $\beta$ are both of the form $x \mapsto \overline{x}$ with the same case distinction, the diagram commutes.
Now we consider the diagram:
\begin{center}
\begin{adjustbox}{max width=\textwidth}
% https://tikzcd.yichuanshen.de/#-AFAlQgsG4SGw+GI466VHozHYvEE3zDUbEkLISYAZkqlPYvAWIJWa14G22uzlPXZ1w0t303Lk-MFv3+gPaYmB-FB4KlcIRSL0CoxvCxghxonxlHNaqJJS1kwALPrqjEeCa6RamU43k8TnI2dl7I4sry3FdBNdiApw-w8N94N1Tkc+VjeKRs7tc+W4mZns3Dm0lLdMzh9LwWx8vm6RZ7RN7fZLpNCA7KQxGVZZ3Nljg57mY28Aq8RBD5BA2m5k+7ZBBBaDBNqCwDBgD0FK7hYC2+zlVHVYUIyBAmZSkCmFJpvM9RjhIDKWnsha9vmLyIYebjFtI+5lmhlzACWB79Jc5qdl2zJ6ION5xPej7Pq+74fjOX45OyO4PHupa9Dhtr4ahhG-pu-4FBEMBQKI8BEKAWwQN8SBkCAOAQEgkyRJBIBYCughMGguL0AiABUcYgFJMmIMpClIOQEFzCA+jfFwemWFwwAALTwoZxlIDqNDmaZVlUoo9nuZs0lIAA7N5imIHJsxUupx78KI9DfN8umBYBHmIEmEWeX57DqYIsCMDg9BpcMGUAKzZZluW1HFghfKlBnpcFJkAGxVZVKnWXV-D4MV+lBSFiDtfJkXhV1VL1cVaWUD4QA
\begin{tikzcd}
	{K^p \big[ N_q \cup N_p \cup \big/ (L_q \cup N_p) \big]}                                                                                                                                                                               &                                                                                                                                                                                                                                                                                                                                                     \\
	{K^p \big[ N_q \cup N_p \cup C_1(L_q \cup N_p) \big]} \arrow[u, "(m^*)^{-1}"]                                                                                                                                                          & {K^p \left[  \frac{N_q \cup N_p \cup C_1(L_q\cup N_p)}{ \cl (N_q \cup N_p \cup C_1(L_q\cup N_p)\setminus \bigcup\limits{j=1}^l C_1V_j ) } \right]} \arrow[l, "c^*"]                                                                                                                                                                                 \\
	{K^p \big[ N_q \cup N_p \cup C_1(L_q \cup N_p)\cup C_2(N_q\cup N_p) \big]} \arrow[u, "i_{\alpha}^*"]                                                                                                                                   & {K^p \left[  \frac{ C_1(L_q\cup N_p)}{ \cl (C_1(L_q\cup N_p)\setminus \bigcup\limits{j=1}^l C_1V_j ) } \right]} \arrow[u, "i_\delta^*"]                                                                                                                                                                                                             \\
	& { K^p \left[  \frac{ C_1(L_q)}{ \cl (C_1(L_q)\setminus \bigcup\limits{j=1}^l C_1V_j ) } \right]  } \arrow[u, "i_{\eta}^*"]                                                                                                                                                                                                                          \\
	{K^p \left[ \frac{N_q\cup N_p \cup C_1(L_q\cup N_p)\cup C_2(N_q \cup N_p)}{C_2(N_q \cup N_p)}  ,  \frac{ C_1 (L_p \cup \overline{(L_q  \setminus N_p)}) \cup  C_2(N_q \cup N_p)}{C_2(N_q\cup N_p)} \right]} \arrow[uu, "i_{\gamma}^*"] & {K^p\left[ \frac{N_q\cup N_p \cup C_1(L_q\cup N_p)\cup C_2(N_q \cup N_p)}{\{ 0 \} \times (L_q \cup N_p)}  , \frac{N_q\cup N_p \cup C_1 (L_p \cup \cl \left( L_q \setminus \bigcup\limits_{j=1}^l V_j \right)) \cup  C_2(N_q \cup N_p)}{\{0\}\times (L_p \cup \overline{(L_q \setminus N_p)})} \right]} \arrow[u, "i_{\iota}^*"] \arrow[l, "\eta^*"]
\end{tikzcd}
\end{adjustbox}
\end{center}
\end{lemma}
