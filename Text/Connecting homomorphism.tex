...
\begin{align*}
&	i_{\iota}\circ i_{\eta} \circ i_{\delta}\circ c(x)=
	p \Leftrightarrow \\
	...
	= &C_1 \cl \left( (L_q\cup N_p)\setminus \bigcup\limits_{j=1}^l C_1V_j \right) \cup  C_1 (L_p \cup \cl \left( L_q \setminus \bigcup\limits_{j=1}^l V_j \right)) \cup  C_2(N_q \cup N_p)\\
	 =&
\end{align*}
