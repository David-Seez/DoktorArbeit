...
\begin{cor}[The Logic and To-Dos of my Proof]
	...
	\begin{center}
		...
		\begin{tikzcd}
			{(A,B)} \arrow[d, "s"] \arrow[r, "\Phi"] & \bigvee\limits_{j=1}^lS^{k+1}   \arrow[d, "\oplus_j \delta_j \id"] \\
			{S\vee (B,C)} \arrow[r, "\Psi"]          & S^{k+1}                     
		\end{tikzcd}
	...
	\begin{center}
		% https://tikzcd.yichuanshen.de/#-oh4YC9sdOiY0BMrFgoN9YrCkc8DiClicCUSSd1hEA
		\begin{tikzcd}
			{K^{-p+1}(A,B)}                          & K^{-p+1}(	S^{k+1}) \arrow[l, "\Phi^*"] \arrow[r, "q_q"]                       & \Z                  \\
			{K^{-p+1}(S\vee (B,C))} \arrow[u, "s^*"] & K^{-p+1}(\bigvee\limits_{j=1}^lS^{k+1}) \arrow[l, "\Psi^*"] \arrow[r, "q_p"] \arrow[u,"g"] & \Z^l \arrow[u, "h"]
		\end{tikzcd}
