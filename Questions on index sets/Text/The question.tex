...
\end{lemma}
\begin{proof}
Suppose that $\grad(f)=\sum_j V_j \frac{\partial}{\partial x^i}$ and $q$ is the coordinate map $T\R\to \R$ in each tangend space. Then by definition of the gradient we have:
\begin{align*}
	q \circ \diff f (\frac{\partial }{\partial x^j})=q\circ \frac{\partial f}{\partial x^j}= g(\grad(f),)
\end{align*}
\end{proof}
