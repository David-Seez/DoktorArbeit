...
\begin{definition}[Pullback of a Family of Vector Spaces] \label{def:vb-pullbackOfAFamilyOfVectorSpaces}
...
\end{corollary}
\begin{definition}[Trivial Bundle]\label{def:vb-trivialBundle}
	If a family $\pi: E \to X$ is isomorphic to a product family $\tilde{\pi}:X\times V\to X$ (i.e. there exists an invertible homomorphism of families of vector spaces), we call it a \textbf{trivial family}.
\end{definition}
\begin{definition}[Vector Bundle]\label{def:vb-vectorBundle}
