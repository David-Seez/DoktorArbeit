...
Now $V$ is homeomoprhic to $\R^m$ via the coordinate map $\kappa_v$ that maps each vector to its coordinate representation. With this we can introduce a K-theoretic orientation from an ordered basis via the composition: 
   \begin{center}
\begin{tikzcd}
\tilde{K}^n(S^n) \arrow[r, "(\pi_S^{-1})^*"] & \tilde{K}^n(\overline{\R^m}) \arrow[r, "B_v^*"] & \tilde{K}^m(\overline{V})
\end{tikzcd}
...
\begin{center}
\begin{tikzcd}
\tilde{K}^m(S^m) \arrow[r, "(\pi_S^{-1})^*"] & \tilde{K}^n(\overline{\R^m}) \arrow[r, "\kappa_v^*"] \arrow[d, "\id"] & \tilde{K}^m(\overline{V}) \arrow[d, "\id"] \\
\tilde{K}^m(S^m) \arrow[r, "(\pi_S^{-1})^*"] & \tilde{K}^n(\overline{\R^m}) \arrow[r, "\kappa^*_{v'}"]               & \tilde{K}^m(\overline{V})                 
\end{tikzcd}
\end{center}
