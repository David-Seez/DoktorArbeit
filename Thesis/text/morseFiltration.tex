...
\begin{remark}\label{rem:morseFiltr-morphismToCanonicalIntegers}
	...
	\begin{align*}
	\kappa_q\coloneq R_0\circ \restr{\diff \phi^{-1}}{0}\circ s \circ \phi	\,:\,(\phi^{-1}( D^{s }_\epsilon\times  D^{u }_\epsilon),\phi^{-1}( D^{ s}_\epsilon\times \partial D^{u}_\epsilon))  \to (\overline{T^u_qM},\{\infty\})
	\end{align*} where $s$ is the streching $x\mapsto x\cdot (\frac{1}{\epsilon}-\norm{x}-\frac{1}{\epsilon})$ with $\restr{\diff s}{0}=\frac{1}{\epsilon}\Idm$.
\end{remark}
