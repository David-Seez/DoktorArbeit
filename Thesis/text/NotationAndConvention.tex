...
\begin{longtable}{@{} p{3.5cm} p{3.5cm} p{7cm} @{}}
	...
	Singular
	& $(\ChSing_*(X),\,\bS)$
	& boundary $\bS$; homology $\HS_*(X)$.
	Macros: \texttt{\textbackslash ChS}, \texttt{\textbackslash bS},
	\texttt{\textbackslash HS}. \\[4pt]
	...
	\multicolumn{3}{@{}p{14cm}}{%
		\textbf{Connecting homomorphisms in long exact sequences:} : $\connM, \connCW, \connS $ with the macros:  \texttt{\textbackslash connM}, \texttt{\textbackslash connCW},
		\texttt{\textbackslash connS}. }\\[4pt]
	\multicolumn{3}{@{}p{14cm}}{%
		\textbf{Co-homology:} : For co-homology we use upper indices on the co-boundary maps: $\cbM, \cbCW,\cbS$ with the macros: \texttt{\textbackslash cbM}, \texttt{\textbackslash cbCW},
		\texttt{\textbackslash cbS}. And for the co-homology we use the homlogie macros with upper indices.}
	\\[4pt]
