...
\let\Top\relax    \DeclareMathOperator{\Top}{\mathbf{Top}}
\let\hTop\relax   \DeclareMathOperator{\hTop}{\mathbf{hTop}}
...
\let\TopC\relax   \DeclareMathOperator{\TopC}{\mathbf{TopC}}
\let\hTopC\relax  \DeclareMathOperator{\hTopC}{\mathbf{hTopC}}
\let\TopCPair\relax   \DeclareMathOperator{\TopCPair}{\mathbf{TopC^{2}}}
\let\TopCPoint\relax  \DeclareMathOperator{\TopCPoint}{\mathbf{TopC^{0}}}
\let\hTopP\relax  \DeclareMathOperator{\hTopP}{\mathbf{hTopP}}
...
% ---- Morse theory -----------------------------------------------------
\providecommand{\ChM}{C^{\mathrm{M}}}
\providecommand{\ChCW}{C^{\mathrm{CW}}}
\providecommand{\ChSing}{C}
\providecommand{\bM}{\partial^{\mathrm{M}}}
\providecommand{\bCW}{\partial^{\mathrm{CW}}}
\providecommand{\HM}{H^{\mathrm{M}}}
\providecommand{\HCW}{H^{\mathrm{CW}}}
