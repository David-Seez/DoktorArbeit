...
% ---- Categories -------------------------------------------------------
\DeclareMathOperator{\CIAB}{\mathbf{CIAB}}
\DeclareMathOperator{\CSS}{\mathbf{CSS}}
\DeclareMathOperator{\CIRing}{\mathbf{CIRing}}
...
\let\TopP\relax   \DeclareMathOperator{\TopP}{\mathbf{CGWH^*}}
...
\newcommand{\bottmap}[1][-]{\bottg\boxtimes(#1)}
