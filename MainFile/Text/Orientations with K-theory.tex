...
\end{align*} is orientation preserving. $\omega^n$ denotes the standars orientation of $\R^n$. If such an orientation exists, we call the bundle \textbf{orientable}. Notice how we can either use the classical or the K-theoretic notion of the standart orientation of $R^n$. 
\end{definition}
