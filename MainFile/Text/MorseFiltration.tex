...
\end{prop}
\begin{proof}
	Compare Proposition 3.4 in \cite{Salamon1985}.
\end{proof}
\begin{definition}[Local Flow]
	A locally compact subset $X\subseteq \Gamma$ is said to be a local flow if for every $\gamma in X$ there exists a neighbourhood $U$ of $\gamma$ in $\Gamma$ and an $\epsilon >0$ such that $\phi_{[0,\epsilon]}{()X\cap U)}\subseteq X$.
\end{definition}
\begin{definition}
	Let $X\subseteq \Gamma$ be a local flow and let $S\subseteq X$ be a compact invariant set. Then $S$ is said to be an isolated invarianat set if there exists a compact neighborhood $N$ of $S$ in $X$ such that $D=I(N)$. In that cse $N$ is said to be an isolating neighbourhood (for $S$ in $X$).
\end{definition} 
\begin{definition}
