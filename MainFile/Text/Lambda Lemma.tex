...
\begin{corollary} \label{cor: lambda lemma flow lines have decreasing index}
...
\end{remark}
\begin{corollary}\label{cor: Subspaces are also close}
...
\begin{corollary}\label{cor: lambda lemma first corollary} Let $M$ be a smooth manifold and suppose that $p,q$ are hyperbolic fixpoints of a diffeomorphism $\phi:M\to M$. If $W(q \to)$ and $W(\to p)$ have a point of transversal intersection, then 
\begin{align*}
...
\begin{corollary}[Transitivity of gradient lines for diffeomorphisms] \label{cor: transitivity of fixpoints}
...
\begin{corollary}[Transitivity of gradient lines for critical points] \label{cor: lambda lemma transitivity of critical points}
...
\end{enumerate}
\end{proof}
\begin{corollary}\label{cor: lambda lemma corollary a} For any critical point $q$ of $f$ we have that
\begin{align*}
...
\end{proof}
\begin{corollary} \label{cor: lambda lemma corollary b}
...
\end{proof}
\begin{corollary}\label{cor: lambda lemma closer of (un-)stabnle sets}
...
\end{proof}
\begin{corollary} If $p$ and $q$ are critical points and $q \succeq p$, then 
\begin{align*}
