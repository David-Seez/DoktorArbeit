...
\begin{proof}[Proof of Theorem \ref{thm commuting connecting homomorphism}]
	...
	By definition we get the triple connecting morphism as the composition of the inclusion with the connecting homomorphism of the pair:\todo{check if $\big[S_1 \wedge L_q\cup N_p , S_1 \wedge  L_p \cup \inti(L_q \setminus{N_p})\big]$ or $\big[S_1 \wedge L_q\cup N_p , S_1 \wedge  L_p \cup (L_q \setminus\mathring{N_p})\big]$ is correct!}
	\begin{center}
		\begin{adjustbox}{max width=\textwidth}
			% https://tikzcd.yichuanshen.de/#-KitIiYlZobDxptpiV-lFkECBCC6skmpsocN8c1RiJEQJkbcxmgJl8ibNwmVSUDiJTVuDaccUUy4ZjNgB6R706Xowk-Yn8xZCmqg6kQzLihkGQ6Kk7c4LxS7wIigABmACcIE4kGQQDgIEhKgkqQ0sFwAFQqkC2+1umgupBAkCMVxgqAQZiSRhsGgACxg9Cg7EgYETzvoWEYGYIbGKAbtDsQTtDiHINEjWfYMbjCZAydT6YamezOFz+fbhf9gbL4crABZNZ6QBImGgk-Rff3S0hR87XYgAKxjkVYRTASeMaf0IRz4sDpDr5dIABsG7BVicvp8PDS86DiAA7CGV1eI1H67H49mUzTAs6xDbtgKLGYT0Qd1K3fD0RQkWBGC7bc0FzG0hGfMtq3PRBwxWMEtx3KRHAPI9KCEIA
			\begin{tikzcd}
				...
				{K^{p-1} \big[L_q\cup N_p ,  L_p \cup \cl(L_q \setminus{N_p})\big]} \arrow[u, "i^*"] \arrow[r, no head, Rightarrow] & {K^{p} \big[S_1 \wedge L_q\cup N_p , S_1 \wedge  L_p \cup \cl (L_q \setminus{N_p})\big]} \arrow[u, "i_{\beta}^*"] &                                                                                                     
			\end{tikzcd}
		\end{adjustbox}
	\end{center}
