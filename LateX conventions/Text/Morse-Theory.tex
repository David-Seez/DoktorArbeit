...
\begin{proof}
	...
	\begin{equation}
		x^tAx=\sum_{i=1}^{k}\lambda_i x_i^t A x=\sum_{i,j=1}^{k}\lambda_i \lambda_j x_i^t A x_j=\sum_{i=1}^{k}(\lambda_i)^2 > 0 \,. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Bis Hier bin ich bis jetzt gekommen!!!!!!!!!
...
\end{remark}
\begin{definition}\label{def: Definition produce Morse datum}
