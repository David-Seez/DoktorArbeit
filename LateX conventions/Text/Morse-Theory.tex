...
\end{remark}
\begin{definition}
	Let $(M,\mathfrak{A},\Lambda)$ and $(M',\mathfrak{A}',\Lambda)$ be two Morse data with $\mathfrak{A}=(g,f,\mathfrak{o})$ and $ \mathfrak{A}'=(g',f',\mathfrak{o}')$. Then on $M\times M'$ we define the Morse function $f+f'$ and the metric $g\oplus g'$. 
...
\end{definition}
\begin{corollary}
	If $M$ is an oriented manifold, orientations from the unstable tanged space in critical points $T^u_qM$ induce Orientations in the stable  
\end{corollary}
