...
\begin{theorem}[Morse-theoretic Künneth Formula]
	If $\Lambda$ is a principle ideal domain, and let $(M,\mathfrak{A},\Lambda)$ and $(M',\mathfrak{A}',\Lambda)$ be two Morse data. Then there is a splitting short exact sequence 
	\begin{multline*}
		0~\to ~
