...
We then apply this to the diagramm above to push all the spaces into $\R^n$ or rather into a Disk modulo its boundary.

% https://tikzcd.yichuanshen.de/#-H0gAGyvlsfxAvxF90QT8-wPH9EAAdlA8D3x7JAIIsSgLCAA
\begin{tikzcd}
	{K^p\left[N_q \big/(L_q)\right]} \arrow[r]                                                                                                                      & {K^p[D^u_{\epsilon}\big/\partial D^u_{\epsilon} ]} \arrow[r] \arrow[d]          & {K^p[S^{\lambda_p+1}]} \arrow[d]                                  \\
	{K^p\left[N_q\cup N_p\cup C_1(L_q\cup N_p)\right]} \arrow[u] \arrow[ru]                                                                                         & {K^p[B_2(0)]} \arrow[r]                                                         & {K^p\left[C_1T^u_pM \big/ \partial C_1 T^u_pM \right]} \arrow[ld] \\
	{K^p 		\left[   			\frac{ C_1(L_q)} 				 { \cl  				 	\left( 				 		C_1(L_q)\setminus \bigcup\limits_{j=1}^l C_1V_j  				 	\right)  				 } 		\right]} \arrow[u] & {K^p\left[C_1V_j \big/ \partial C_1 V_j\right]} \arrow[lu, "\kappa"'] \arrow[l] &                                                                  
\end{tikzcd}
