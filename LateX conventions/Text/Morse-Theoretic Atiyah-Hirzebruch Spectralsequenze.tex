...
\begin{center}
% https://tikzcd.yichuanshen.de/#-gC+G201nY2t-UFM3xy8wyqYKF94IlBZCGckMhAcCCQAJgKnmReSAqHy+iG+NGmtTmggA1vQ0G0Bv9AYhgZ83tdDEA
\begin{tikzcd}
	{K^p\left[N_q\cup N_p\cup C_1(L_q\cup N_p)\right]}                                                          &                                                              \\
K^p \left[  \frac{ C_1(L_q)}{ \cl \left(C_1(L_q)\setminus \bigcup\limits_{j=1}^l C_1V_j \right) } \right]  \arrow[u] & C_1V_j \big/ \partial C_1 V_j \arrow[lu, "\kappa"] \arrow[l]
	\end{tikzcd}
\end{center}
