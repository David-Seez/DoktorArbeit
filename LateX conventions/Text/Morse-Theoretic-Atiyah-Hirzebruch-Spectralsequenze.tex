...
\begin{definition} Let $M$ be a smooth manifold with Morse data and \begin{equation*}
	...
	\begin{equation*}
		{K^{p+q}(N_{p+r-1},N_{p-r})}\slash \ker \alpha \to \ker\big[K^{p+q+1}(N_{p+2r-1},N_{p})\to K^{p+q+1}(N_{p+r-1},N_{p})  \big]
	...
	\begin{equation*}
		\frac{\ker~ d^{p+r,q-r+1}_r}{\im~ d^{p,q}_r}
	\end{equation*} is well defined. Now $\ker~ d^{p+r,q-r+1}_r=\ker[K^{p+q+1}(N_{p+2r+1},N_{p+1})\to(K^{p+q+1}(N_{p+r-1},N_{p+1}))]$, since: \todo{hier weiter machen}
\end{definition}
